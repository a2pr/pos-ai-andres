...
function makeContext(products,users){
    ...
    const colorsIndex = Object.fromEntries(colors.map((color,index)=>{ return [color, index]}))
    const categoryIndex = Object.fromEntries(categories.map((category,index)=>{ return [category, index]}))
    
    //Computar a media de idade dos comprados por produto
...
function encodeProduct(product, context){
    //normalizando dados para ficar de 0,1 e aplicar peso nna recomendaçao
